...
function suppliers_insert(){
	...
	$data['HomePage'] = makeSafe($_POST['HomePage']);
	...
	if(function_exists('suppliers_after_insert')){
		$res = sql("select * from `suppliers` where `SupplierID`='" . makeSafe($recID) . "' limit 1", $eo);
	...
	sql("insert into membership_userrecords set tableName='suppliers', pkValue='$recID', memberID='".getLoggedMemberID()."', dateAdded='".time()."', dateUpdated='".time()."', groupID='".getLoggedGroupID()."'", $eo);
