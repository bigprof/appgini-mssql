<?php
	...
	*/
	 ...
	 *     $data['TitleOfCourtesy'], $data['Photo'], $data['LastName'], $data['FirstName'], $data['Title'], $data['BirthDate'], $data['HireDate'], $data['Address'], $data['City'], $data['Region'], $data['PostalCode'], $data['Country'], $data['HomePhone'], $data['Extension'], $data['Notes'], $data['ReportsTo']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['EmployeeID'], $data['TitleOfCourtesy'], $data['Photo'], $data['LastName'], $data['FirstName'], $data['Title'], $data['BirthDate'], $data['HireDate'], $data['Address'], $data['City'], $data['Region'], $data['PostalCode'], $data['Country'], $data['HomePhone'], $data['Extension'], $data['Notes'], $data['ReportsTo']
