<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'categories' table. 
	...
	*/
	 ...
	 *     $data['Picture'], $data['CategoryName'], $data['Description']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['CategoryID'], $data['Picture'], $data['CategoryName'], $data['Description']
