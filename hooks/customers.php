<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'customers' table. 
	...
	*/
	 ...
	 *     $data['CompanyName'], $data['ContactName'], $data['ContactTitle'], $data['Address'], $data['City'], $data['Region'], $data['PostalCode'], $data['Country'], $data['Phone'], $data['Fax']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['CustomerID'], $data['CompanyName'], $data['ContactName'], $data['ContactTitle'], $data['Address'], $data['City'], $data['Region'], $data['PostalCode'], $data['Country'], $data['Phone'], $data['Fax']
