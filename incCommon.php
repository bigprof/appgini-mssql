<?php
	...
	*/
	...
	function getTableList($skip_authentication = false){
		...
		$arrTables = array(   
			'customers' => array('Customers', 'The customers table contains a list of imaginary customers of the Northwind company.

 You can also access the imaginary orders made by each customer here.', 'resources/table_icons/account_balances.png'),
			'employees' => array('Employees', 'This table lists the employees of \'Northwind\', sorted by last name.
...
by clicking the Employees button.', 'resources/table_icons/administrator.png'),
			'orders' => array('Orders', 'Orders placed by customers, with newest orders listed first.
 Order dates can be specified using
 a friendly date picker that AppGini automatically generates for date fields.', 'resources/table_icons/cash_register.png'),
			'order_details' => array('Order Items', 'This table lists the items in each order. It\'s recommended to first select an order from the \'Orders\' 
table.
 You can then access that order\'s items from there.', 'resources/table_icons/application_form_magnify.png'),
			'products' => array('Products', 'In addition to to accessing product details, you can also access the orders history of each 
product from here.', 'resources/table_icons/handbag.png'),
			'categories' => array('Product Categories', 'Product categories include photos that have been automatically resized using the 
thumbnails feature provided by AppGini.
 Click on a thumbnail to enlarge it. Signed users can upload photos when defining new categories.', 'resources/table_icons/award_star_bronze_1.png'),
			'suppliers' => array('Suppliers', 'In addition to to accessing suppliers\' details, you can also view products 
provided by each supplier.', 'resources/table_icons/car.png'),
			'shippers' => array('Shippers', 'Here you can access shippers info, and also see orders handled by each shipper.', 'resources/table_icons/cart.png')
		);
